...
export default function SeoForm({ currentPage, currentMetadata }: { currentPage: string, currentMetadata: any }) {
        ...
        <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 rounded-3xl p-10 md:p-14 shadow-2xl relative overflow-hidden">
            ...
            <form action={formAction} className="grid md:grid-cols-2 gap-x-8 gap-y-10 relative z-10">
                ...
                <div className="flex flex-col gap-3 md:col-span-2 group">
                    ...
                    <input type="text" name="title" defaultValue={currentMetadata?.title || ''} placeholder="Enter page title..." required
                           className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-base focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium placeholder:text-slate-700"/>
                ...
                <div className="flex flex-col gap-3 md:col-span-2 group">
                    ...
                    <textarea name="description" defaultValue={currentMetadata?.description || ''} placeholder="Enter structural meta description..." required
                              className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-base min-h-[160px] resize-y focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium leading-relaxed placeholder:text-slate-700"></textarea>
                ...
                <div className="flex flex-col gap-3 group">
                    ...
                    <input type="text" name="keywords" defaultValue={currentMetadata?.keywords || ''} placeholder="keyword1, keyword2, ..."
                           className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium placeholder:text-slate-700"/>
                </div>
                ...
                <div className="flex flex-col gap-3 group">
                    ...
                    <input type="url" name="canonical" defaultValue={currentMetadata?.canonical || ''} placeholder="https://karmana.com/path"
                           className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium placeholder:text-slate-700"/>
                </div>
                ...
                <div className="flex flex-col gap-3 group">
                    ...
                    <input type="url" name="og_url" defaultValue={currentMetadata?.og_url || ''} placeholder="https://karmana.com/path"
                           className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium placeholder:text-slate-700"/>
                </div>
                ...
                <div className="flex flex-col gap-3 md:col-span-2 mb-2 group">
                    ...
                    <input type="url" name="publisher" defaultValue={currentMetadata?.publisher || ''} placeholder="https://brand-profile.com"
                           className="bg-[#020617]/50 border border-white/5 p-5 rounded-2xl text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-[#020617]/80 focus:ring-1 focus:ring-amber-500/20 transition-all font-medium placeholder:text-slate-700"/>
                </div>
                ...
                <button type="submit" disabled={isPending}
                    ...
                    {isPending ? 'Synchronizing State...' : 'Commit Metadata to Core'}
                </button>
            </form>
        </div>
    );
