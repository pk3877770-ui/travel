...
const posts = [
  {
    ...
    excerpt: "Explore the latest trends in luxury private aviation and how Karmana is setting new standards.",
    date: "May 15, 2026",
    author: "Alexis Vance",
          ...
          {posts.map((post, idx) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <Image
                  src={post.image}
                  alt={`Karmana Journal: ${post.title} - ${post.category} Insights`}
                  fill
